...
public final class AddAllGamesToDB
{
    ...
    private AddAllGamesToDB() throws SQLException, InterruptedException
    {
        setup();
    ...
    private long insertParticipant(long matchid, Participant participant) throws SQLException
    {
        ...
        pInsertStatement.setLong(4, participant.getSpell1().getId());
        pInsertStatement.setLong(5, participant.getSpell2().getId());
    ...
    private void insertTeamData(long matchid, Match match) throws SQLException
    {
        for (TeamStats team : match.getTeamStats())
        {
            ...
            tsInsertStatement.setLong(2, team.getTeamType().getCode());
            ...
            for (BannedChampion ban : team.getBans())
            {
                ...
                tbInsertStatement.setLong(2, team.getTeamType().getCode());
    ...
    private long insertMatch(Match match) throws SQLException
    {
        ...
        matchInsertStatement.setLong(5, match.getMatchDuration());
    ...
    private static final L4J8  api = new L4J8(null);
